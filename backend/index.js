...
//     // Note: Changed payload property from userId to id for consistency.
...
//     const where = decoded.role === 2 ? {} : { ownerId: decoded.userId };
...
// //   // if(!token) return res.status(401).json({ error: "unauthorized"});
// //   try{
// //       const attendance = await prisma.project.create({
// //         data:{
// //           employeeId,
// //           time: new Date(time),
// //         },
...
// //   }
// //   catch(err){
// //     res.status(500).json({ error: "Failed to Send Attendance"});
// //   }
// // });
// //////
// app.post("/attendance", async (req, res) => {
...
// // Attendance Endpoint: Get Attendance Records for an Employee
